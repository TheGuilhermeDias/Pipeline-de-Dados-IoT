...
fig2 = px.line(df_leituras_hora, x='hora',
               y='total_leituras', title="Leituras por Hora")
st.plotly_chart(fig2)


st.header('Temperatura Máxima e Mínima por Dia')
df_temp_max_min = load_data('temp_max_min_por_dia')
fig3 = px.line(df_temp_max_min, x='data', y=[
               'temp_maxima', 'temp_minima'], title="Temperatura Máxima e Mínima por Dia")
